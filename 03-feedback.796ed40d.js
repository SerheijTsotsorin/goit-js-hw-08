...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const r=document.querySelector(".feedback-form"),a="feedback-form-state",o={};function l(e){o[e.target.name]=e.target.value,localStorage.setItem("STORAGE_KEY",JSON.stringify(o))}function n(){let e=localStorage.getItem("STORAGE_KEY");e&&(e=JSON.parse(e),Object.entries(e).forEach(([e,t])=>{o[e]=t,r.elements[e].value=t}))}function c(e){e.preventDefault(),e.currentTarget.reset(),localStorage.getItem("STORAGE_KEY")&&console.log(localStorage.getItem("STORAGE_KEY")),localStorage.removeItem("STORAGE_KEY")}n(),r.addEventListener("input",(0,e.default)(l,500)),r.addEventListener("submit",c);
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.796ed40d.js.map