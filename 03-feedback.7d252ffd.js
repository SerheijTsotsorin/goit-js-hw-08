...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a={form:document.querySelector(".feedback-form"),textarea:document.querySelector(".feedback-form textarea"),input:document.querySelector(".feedback-form input")},r="feedback-form-state",o={email:"",message:""};function n(e){e.preventDefault(),e.currentTarget.reset(),localStorage.getItem(r)&&console.log(localStorage.getItem(r)),localStorage.removeItem(r)}function l(e){o.email=e.target.value,localStorage.setItem(r,JSON.stringify(o))}function u(e){o.message=e.target.value,localStorage.setItem(r,JSON.stringify(o))}function c(){const e=JSON.parse(localStorage.getItem(r));e&&(a.input.value=e.email,a.textarea.value=e.message)}a.form.addEventListener("submit",n),a.textarea.addEventListener("input",(0,e.default)(u,500)),a.input.addEventListener("input",(0,e.default)(l,500)),c();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.7d252ffd.js.map